...
(defvar pcomplete-declare-magento-subcommands
  '("help" "list" "admin:user:create" "admin:user:unlock" "app:config:dump"
    "app:config:import" "app:config:status" "cache:clean" "cache:disable"
    "cache:enable" "cache:flush" "cache:status" "catalog:images:resize"
    "catalog:product:attributes:cleanup" "config:sensitive:set" "config:set"
    "config:show" "cron:install" "cron:remove" "cron:run"
    "customer:hash:upgrade" "deploy:mode:set" "deploy:mode:show" "dev:di:info"
    "dev:profiler:disable" "dev:profiler:enable" "dev:query-log:disable"
    "dev:query-log:enable" "dev:source-theme:deploy"
    "dev:template-hints:disable" "dev:template-hints:enable" "dev:tests:run"
    "dev:urn-catalog:generate" "dev:xml:convert"
    "encryption:payment-data:update" "i18n:collect-phrases" "i18n:pack"
    "i18n:uninstall" "indexer:info" "indexer:reindex" "indexer:reset"
    "indexer:set-dimensions-mode" "indexer:set-mode"
    "indexer:show-dimensions-mode" "indexer:show-mode" "indexer:status"
    "info:adminuri" "info:backups:list" "info:currency:list"
    "info:dependencies:show-framework" "info:dependencies:show-modules"
    "info:dependencies:show-modules-circular" "info:language:list"
    "info:timezone:list" "maintenance:allow-ips" "maintenance:disable"
    "maintenance:enable" "maintenance:status" "module:disable" "module:enable"
    "module:status" "module:uninstall" "msp:security:recaptcha:disable"
    "msp:security:tfa:disable" "msp:security:tfa:providers"
    "msp:security:tfa:reset" "newrelic:create:deploy-marker"
    "queue:consumers:list" "queue:consumers:start" "sampledata:deploy"
    "sampledata:remove" "sampledata:reset" "setup:backup" "setup:config:set"
    "setup:cron:run" "setup:db-data:upgrade"
    ...
    "setup:static-content:deploy" "setup:store-config:set" "setup:uninstall"
    "setup:upgrade" "store:list" "store:website:list" "theme:uninstall"
...
(defvar pcomplete-declare-magento-config-options
  '("web/seo/use_rewrites" "web/unsecure/base_url"
    ...
    "web/default/cms_no_route" "web/default/front" "web/cookie/cookie_path"
    "web/cookie/cookie_domain" "web/cookie/cookie_httponly" "web/url/use_store"
    ...
    "general/store_information/country_id" "general/store_information/region_id"
    ...
    "currency/import/service" "currency/import/time" "currency/import/frequency"
    "currency/import/error_email" "catalog/category/root_id"
    "catalog/frontend/list_allow_all" "catalog/frontend/flat_catalog_product"
    "catalog/frontend/list_mode" "catalog/frontend/grid_per_page_values"
    "catalog/frontend/grid_per_page" "catalog/frontend/flat_catalog_category"
    ...
    "catalog/downloadable/shareable" "catalog/downloadable/content_disposition"
    "catalog/custom_options/use_calendar" "catalog/custom_options/year_range"
    "catalog/placeholder/placeholder" "catalog/placeholder/image_placeholder"
    "catalog/placeholder/small_image_placeholder"
    "catalog/placeholder/swatch_image_placeholder"
    "catalog/placeholder/thumbnail_placeholder" "catalog/review/allow_guest"
    "catalog/layered_navigation/display_product_count"
    "catalog/seo/product_use_categories" "catalog/seo/category_canonical_tag"
    ...
    "analytics/url/signup" "analytics/url/update" "analytics/url/bi_essentials"
    "analytics/url/otp" "analytics/url/report"
    ...
    "sync_settings/addressbook/allow_non_subscribers" "design/theme/theme_id"
    ...
    "design/head/includes" "design/head/demonotice" "design/head/shortcut_icon"
    "design/header/logo_src" "design/header/logo_width"
    "design/header/logo_height" "design/header/logo_alt" "design/header/welcome"
    "design/footer/copyright" "design/footer/absolute_footer"
    "design/footer/report_bugs" "design/search_engine_robots/default_robots"
    ...
    "design/watermark/small_image_position" "design/watermark/thumbnail_size"
    "design/watermark/thumbnail_imageOpacity"
    "design/watermark/thumbnail_position" "design/watermark/swatch_image_size"
    ...
    "design/email/logo" "mgstheme/general/width" "mgstheme/general/layout_style"
    "mgstheme/general/layout" "mgstheme/general/header"
    "mgstheme/general/footer" "mgstheme/general/sticky_menu"
    "mgstheme/general/back_to_top" "mgstheme/general/popup_newsletter"
    "mgstheme/general/breadcrumb" "mgstheme/fonts/default_font"
    "mgstheme/fonts/h1" "mgstheme/fonts/h2" "mgstheme/fonts/h3"
    "mgstheme/fonts/h4" "mgstheme/fonts/h5" "mgstheme/fonts/h6"
    "mgstheme/fonts/btn" "mgstheme/fonts/price" "mgstheme/fonts/menu"
    "mgstheme/fonts/menu_link" "mgstheme/fonts/custom_fonts_element"
    "mgstheme/fonts/custom_font_fml" "mgstheme/fonts/default_font_size"
    "mgstheme/fonts/h1_font_size" "mgstheme/fonts/h2_font_size"
    "mgstheme/fonts/h3_font_size" "mgstheme/fonts/h4_font_size"
    "mgstheme/fonts/h5_font_size" "mgstheme/fonts/h6_font_size"
    "mgstheme/fonts/price_font_size" "mgstheme/fonts/btn_font_size"
    "mgstheme/fonts/menu_font_size" "mgstheme/fonts/menu_link_font_size"
    "mgstheme/fonts/custom_font_size" "mgstheme/background/background_color"
    ...
    "mgstheme/background/background_image" "mgstheme/custom_style/font_name"
    "mgstheme/custom_style/style" "mgstheme/custom_style/ttf_file"
    "mgstheme/custom_style/eot_file" "mgstheme/custom_style/woff_file"
    "mgstheme/custom_style/svg_file" "mpanel/catalog/product_per_row"
    "mpanel/catalog/max_width_image" "mpanel/catalog/max_width_image_detail"
    "mpanel/catalog/sale_label" "mpanel/catalog/new_label"
    "mpanel/catalog/picture_ratio" "mpanel/catalog/featured"
    "mpanel/catalog/hot" "mpanel/catalog/preload"
    "mpanel/catalog/wishlist_button" "mpanel/catalog/compare_button"
    ...
    "mpanel/contact_google_map/pin_google_map" "mpanel/product_details/sku"
    "mpanel/product_details/reviews_summary" "mpanel/product_details/wishlist"
    "mpanel/product_details/compare" "mpanel/product_details/short_description"
    "mpanel/product_details/upsell_products"
    "mpanel/product_tabs/show_description" "mpanel/product_tabs/show_additional"
    ...
    "brand/list_page_settings/description" "brand/view_page_settings/template"
    ...
    "brand/sidebar_settings/enabled" "brand/sidebar_settings/show_brand_name"
    ...
    "payment/braintree/private_key" "payment/braintree/merchant_account_id"
    ...
    "payment/braintree/specificcountry" "payment/braintree/countrycreditcard"
    "payment/braintree/verify_3dsecure" "payment/braintree/threshold_amount"
    "payment/braintree/verify_all_countries"
    "payment/braintree/verify_specific_countries"
    "payment/braintree/descriptor_name" "payment/braintree/descriptor_phone"
    ...
    "payment/amazon_payment/merchant_id" "payment/amazon_payment/access_key"
    ...
    "payment/amazon_payment/payment_region" "payment/amazon_payment/sandbox"
    "payment/amazon_payment/active" "payment/amazon_payment/lwa_enabled"
    ...
    "payment/amazon_payment/button_color" "payment/amazon_payment/button_size"
    ...
    "payment/cashondelivery/max_order_total" "payment/cashondelivery/sort_order"
    "payment/free/specificcountry" "payment/checkmo/specificcountry"
    "payment/checkmo/payable_to" "payment/checkmo/mailing_address"
    "payment/checkmo/min_order_total" "payment/checkmo/max_order_total"
    "payment/checkmo/sort_order" "payment/checkmo/active"
    "payment/banktransfer/specificcountry" "payment/banktransfer/instructions"
    "payment/banktransfer/min_order_total"
    "payment/banktransfer/max_order_total" "payment/banktransfer/sort_order"
    "payment/banktransfer/active" "payment/banktransfer/title"
    "payment/banktransfer/order_status" "payment/purchaseorder/specificcountry"
    "payment/purchaseorder/min_order_total"
    "payment/purchaseorder/max_order_total" "payment/purchaseorder/sort_order"
    ...
    "payment/monetaweb2common/cancel_on_failure" "payment/monetaweb2/active"
    "payment/monetaweb2/title" "payment/monetaweb2/test_mode"
    "payment/monetaweb2/payment_action" "payment/monetaweb2/language"
    "payment/monetaweb2/currency" "payment/monetaweb2/allowspecific"
    "payment/monetaweb2/specificcountry" "payment/monetaweb2/min_order_total"
    ...
    "payment/monetaweb2mybank/test_mode" "payment/monetaweb2mybank/language"
    "payment/monetaweb2mybank/currency" "payment/monetaweb2mybank/allowspecific"
    ...
    "contact/email/recipient_email" "cataloginventory/options/show_out_of_stock"
    "cataloginventory/item_options/auto_return"
    "cataloginventory/item_options/notify_stock_qty" "sitemap/category/priority"
    "sitemap/page/priority" "sitemap/generate/enabled" "sitemap/generate/time"
    ...
    "sales_email/invoice_comment/enabled" "sales_email/invoice_comment/copy_to"
    "sales_email/shipment/copy_to" "sales_email/shipment_comment/copy_to"
    ...
    "checkout/klarna_kp_design/color_radius_border" "shipping/origin/country_id"
    "shipping/origin/region_id" "shipping/origin/postcode"
    "shipping/origin/city" "shipping/origin/street_line1"
    "shipping/origin/street_line2"
    "shipping/shipping_policy/enable_shipping_policy"
    "shipping/shipping_policy/shipping_policy_content"
    "multishipping/options/checkout_multiple" "paypal/general/merchant_country"
    "paypal/general/business_account" "paypal/wpp/api_authentication"
    "paypal/wpp/api_username" "paypal/wpp/api_password"
    "paypal/wpp/api_signature" "paypal/wpp/sandbox_flag" "paypal/wpp/use_proxy"
    ...
    "paypal/fetch_reports/time" "paypal/style/logo" "paypal/style/page_style"
    "paypal/style/paypal_hdrimg" "paypal/style/paypal_hdrbackcolor"
    "paypal/style/paypal_hdrbordercolor" "paypal/style/paypal_payflowcolor"
    "klarna/api/api_version" "klarna/api/merchant_id" "klarna/api/shared_secret"
    "klarna/api/test_mode" "klarna/api/debug" "customer/address/street_lines"
    "customer/address/prefix_show" "customer/address/prefix_options"
    "customer/address/middlename_show" "customer/address/suffix_show"
    "customer/address/suffix_options" "customer/address/dob_show"
    "customer/address/taxvat_show" "customer/address/gender_show"
    "customer/address/telephone_show" "customer/address/company_show"
    ...
    "system/full_page_cache/varnish/grace_period" "system/smtp/set_return_path"
    "system/smtp/host" "system/smtp/port" "system/currency/installed"
    "system/backup/enabled" "mgs_quickview/general/enabled"
    ...
    "mgs_quickview/general/hide_qty" "mgs_quickview/general/hide_availability"
    ...
    "amgeoip/import/rows_count/location" "amgeoip/import/current_row/block"
    "amgeoip/import/current_row/location" "amgeoip/import/date_download"
    "amgeoipredirect/general/enable" "amgeoipredirect/restriction/apply_logic"
    ...
    "admin/security/use_case_sensitive_login" "admin/security/session_lifetime"
    "admin/url/custom" "mailchimp/general/active" "mailchimp/general/apikeylist"
    ...
    "social/twitter_settings/active" "social/instagram_setting/enable_instagram"
    ...
    "aw_rma/blocks_and_policy/policy_block" "aw_rma/contacts/department_name"
    "aw_rma/contacts/department_email" "aw_rma/contacts/department_address"
    ...
    "carriers/flatrate/active" "carriers/freeshipping/free_shipping_subtotal"
    "carriers/freeshipping/specificcountry" "carriers/freeshipping/showmethod"
    "carriers/freeshipping/sort_order" "carriers/tablerate/active"
    "carriers/tablerate/title" "carriers/tablerate/name"
    "carriers/tablerate/condition_name" "carriers/tablerate/handling_fee"
    "carriers/tablerate/specificcountry" "carriers/tablerate/showmethod"
    "carriers/tablerate/sort_order" "carriers/tablerate/include_virtual_price"
    ...
    "carriers/temando/bearer_token" "carriers/temando/collectionpoints_enabled"
    ...
    "smtp/configuration_option/username" "smtp/configuration_option/password"
    "smtp/configuration_option/return_path_email"
    "smtp/configuration_option/test_email/from"
    "smtp/configuration_option/test_email/to" "smtp/developer/developer_mode"
    "mageplaza/general/notice_enable" "mageplaza/general/notice_type"
    "mageplaza/general/menu" "betterpopup/general/enabled"
    "betterpopup/what_to_show/html_content"
    ...
    "betterpopup/when_to_show/popup_appear" "betterpopup/when_to_show/cookieExp"
    ...
    "cookienotice/content/model_title" "cookienotice/content/custom_accept"
    "cookienotice/content/custom_close" "cookienotice/content/custom_more_info"
    ...
    "tax/classes/default_product_tax_class" "tax/classes/default_customer_code"
    ...
    "tax/calculation/price_includes_tax" "tax/calculation/shipping_includes_tax"
    "tax/calculation/discount_tax" "tax/calculation/cross_border_trade_enabled"
    "tax/notification/ignore_discount" "tax/notification/ignore_price_display"
    ...
    "apptrian_facebookpixel/general/pixel_id" "veslicense/general/vesmegamneu"
    "cms/wysiwyg/enabled" "cms/wysiwyg/use_static_urls_in_catalog"
    "delete_orders/module/active" "delete_orders/module/product_key"
    "delete_orders/module/email" "delete_orders/module/name"
    "delete_orders/module/create" "delete_orders/module/subscribe"
    "ampromo/general/auto_add" "ampromo/messages/gift_selection_method"
    ...
    "ampromo/messages/display_notification" "ampromo/messages/notification_text"
    ...
    "vesall/general/enable_bootstrap_js" "vesall/general/enable_owlcarousel"
    "vesall/general/enable_colorbox" "vesall/general/enable_fancybox"
    ...
    "fraud_protection/signifyd/api_url" "fraud_protection/signifyd/api_key"))
